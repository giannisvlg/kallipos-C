...
***Άσκηση 3***  
Συμπληρώστε στην υλοποίηση της απλά συνδεδεμένης λίστας της παραγράφου 10.4 τις λειτουργίες εύρεσης κόμβου της λίστας με βάση τη θέση του <span class="p-style">search_by_index()</span> και της εύρεσης κόμβου με βάση το αναγνωριστικό φοιτητή <span class="p-style">search_by_id()</span>.
